...
static const MessageTable_t assumes[assume_last] = {
    ...
    {"Could not locate WAD file", "The compile tools could not locate a wad file that the map was referencing. Make sure the file '<mapname>.wa_' exists. This is a file generated by hlcsg and you should not delete it. If you have to run hlrad without this file, use '-waddir' to specify folders where hlrad can find all the wad files."},
}; 
