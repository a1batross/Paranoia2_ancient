...
#else
#define ZHLT_VERSIONSTRING "v2.5.3 rel"
#endif

#define HACK_VERSIONSTRING "Custom Build 1.7"
...
#define ZHLT_NEW_BSP_VERSION                // compile target is BSP31 not BSP30.
#define ZHLT_LARGERANGE
