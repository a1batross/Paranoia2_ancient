...
#define MAX_ENGINE_ENTITIES   4096
...
#define MAX_MAP_ENTSTRING   (2048*1024)
...
#define MAX_MAP_LIGHTING    0x4000000
// arbitrary

#define MAX_MAP_VISIBILITY  0x4000000
// arbitrary
...
#define MAX_TEXTURE_SIZE     ((1024 * 1024 * sizeof(short) * 3) / 2)
...
#define TEXTURE_STEP        8.0f
#define MAX_SURFACE_EXTENT  64
#else
#define TEXTURE_STEP        16.0f // this constant was previously defined in lightmap.cpp. --vluzacn
...
#define ENGINE_ENTITY_RANGE 32767.0
#endif
...
#ifdef ZHLT_NEW_BSP_VERSION
#define LUMP_CLIPNODES2   15		// hull0 goes into LUMP_NODES, hull1 goes into LUMP_CLIPNODES, hull2 goes into LUMP_CLIPNODES2
#define LUMP_CLIPNODES3   16		// hull3 goes into LUMP_CLIPNODES3
...
#ifdef ZHLT_NEW_BSP_VERSION
extern int      g_numclipnodes[MAX_MAP_HULLS];
extern dclipnode_t g_dclipnodes[MAX_MAP_HULLS][MAX_MAP_CLIPNODES];
extern int      g_dclipnodes_checksum[MAX_MAP_HULLS];
#else
