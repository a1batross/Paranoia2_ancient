...
void CHud::Think(void)
{
	...
	if ( m_iFOV == DEFAULT_FOV )//default_fov->value )// buz: turn off
	{  
...
//			gViewPort->UpdateSpectatorPanel();
	...
	// buz: draw crosshair
	if ((g_vSpread[0] && g_iGunMode == 1 && m_SpecTank_on == 0) && gHUD.m_pCvarDraw->value) // Wargon: Прицел рисуется только если hud_draw = 1.
	{
