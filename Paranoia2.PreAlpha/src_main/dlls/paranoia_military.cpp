...
//	DEFINE_FIELD( CMilitary, m_flLastEnemySightTime, FIELD_TIME ), // don't save, go to zero
...
//	DEFINE_FIELD( CMilitary, m_fFirstEncounter, FIELD_BOOLEAN ),
...
//=========================================================
void CMilitary :: SetYawSpeed ( void )
{
	int ys;
...
//	}
	...
	if (m_cAmmoLoaded > 0)
	{
		...
		FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_7DEGREES, 2048, BULLET_MONSTER_AK ); // shoot +-5 degrees
...
//	}
	...
	if (m_cAmmoLoaded > 0)
	{
		...
		{
		case SPETSNAZ_WEAPON_AKS:
			FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_7DEGREES, 2048, BULLET_MONSTER_AK );
			break;
		case SPETSNAZ_WEAPON_GROZA:
			FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_5DEGREES, 2048, BULLET_MONSTER_GROZA );
			break;
		case SPETSNAZ_WEAPON_ASVAL:
			FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_5DEGREES, 2048, BULLET_MONSTER_ASVAL );
			break;
		default:
...
//	}
	...
	if (m_cAmmoLoaded > 0)
	{
		...
		Vector	vecShellVelocity = gpGlobals->v_right * RANDOM_FLOAT(40,90) + gpGlobals->v_up * RANDOM_FLOAT(75,200) + gpGlobals->v_forward * RANDOM_FLOAT(-40, 40);
		EjectBrass ( vecBrassPos, vecShellVelocity, pev->angles.y, m_iBrassShell, TE_BOUNCE_SHELL); 
		FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_5DEGREES, 2048, BULLET_MONSTER_9MM );
