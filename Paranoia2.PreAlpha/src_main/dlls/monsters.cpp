...
{ 
	...
	case CHAR_TEX_SLOSH:
		...
		cnt = 4;
		break;
	// g-cont: paranoia steps added
	case CHAR_TEX_WOODS:
		fvol = fWalking ? 0.2 : 0.5;
		rgsz[0] = "player/pl_wood_scr1.wav";
		rgsz[1] = "player/pl_wood_scr2.wav";
		rgsz[2] = "player/pl_wood_scr3.wav";
		rgsz[3] = "player/pl_wood_scr4.wav";
		cnt = 4;
		break;
	case CHAR_TEX_WOOD:
		fvol = fWalking ? 0.2 : 0.5;
	...
	case CHAR_TEX_ASFALT:
		fvol = fWalking ? 0.2 : 0.5;
		rgsz[0] = "player/pl_asf1.wav";
		rgsz[1] = "player/pl_asf2.wav";
		rgsz[2] = "player/pl_asf3.wav";
		rgsz[3] = "player/pl_asf4.wav";
		cnt = 4;
		break;
	case CHAR_TEX_BETON:
		fvol = fWalking ? 0.2 : 0.5;
		rgsz[0] = "player/pl_beton1.wav";
		rgsz[1] = "player/pl_beton2.wav";
		rgsz[2] = "player/pl_beton3.wav";
		rgsz[3] = "player/pl_beton4.wav";
		cnt = 4;
		break;
	case CHAR_TEX_GRASS:
		fvol = fWalking ? 0.2 : 0.5;
		rgsz[0] = "player/pl_grass1.wav";
		rgsz[1] = "player/pl_grass2.wav";
		rgsz[2] = "player/pl_grass3.wav";
