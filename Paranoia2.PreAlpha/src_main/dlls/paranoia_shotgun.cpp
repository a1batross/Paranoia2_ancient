...
void CShotgun::Attack1()
{
	...
	Vector vecSpread = AdvanceSpread( m_pMySpread->pri_minspread, m_pMySpread->pri_addspread, 5);
	Vector vecDir = m_pPlayer->FireBulletsPlayer( 10, vecSrc, vecAiming, vecSpread, 2048, BULLET_PLAYER_BUCKSHOT, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed );
...
void CShotgun::Attack2()
{
	...
	Vector vecDir = m_pPlayer->FireBulletsPlayer( 7, vecSrc, vecAiming, vecSpread, 2048, BULLET_PLAYER_BUCKSHOT, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed );
