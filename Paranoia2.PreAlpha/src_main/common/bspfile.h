...
#define SURF_NOCULL			(1<<0)		// two-sided polygon (e.g. 'water4b')
...
// reserved
#define SURF_SPECULAR		(1<<10)		// paranoia added
#define SURF_MOVIE			(1<<11)		// screen movie
#define SURF_BUMPDATA		(1<<12)		// this surface have baselight, addlight and lightvecs

#define SURF_REFLECT_PUDDLE		(1<<29)		// special reflected surface (puddle reflection)
#define SURF_REFLECT_FRESNEL		(1<<30)		// special reflected surface (experimental)
#define SURF_REFLECT		(1<<31)		// reflect surface (mirror)
