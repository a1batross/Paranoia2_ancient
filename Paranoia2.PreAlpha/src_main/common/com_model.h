...
#define BRUSH_HAS_PARALLAX	0x0020		// has heightmap
#define BRUSH_TWOSIDE	0x0040		// some types of water
#define BRUSH_CONVEYOR	0x0080		// scrolled texture
#define BRUSH_GLOSSPOWER	0x0100		// gloss power stored in alphachannel of gloss map
#define BRUSH_REFLECT	0x0200		// reflect surface
#define BRUSH_REFLECT_SPEC	0x0400		// experimental
...
typedef struct material_s
{
	...
	unsigned short	gl_heightmap_id;		// heightmap for parallax
	...
	// add new material params here if need
} material_t;
...
typedef struct msurfmesh_s
{
	...
	unsigned int	firstVert;	// VBO hint to draw from this offset
...
typedef struct mextrasurf_s
{
	...
	struct mextrasurf_s	*lightchain;	// for shadowmapping
	int		checkcount;	// used for cin textures

	int		reserved[30];	// just for future expansions or mod-makers
} mextrasurf_t;
